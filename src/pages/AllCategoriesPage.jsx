  ...
  return (
    <>
      ...
      {loading && <h1 style={{textAlign:"center"}}>Loading</h1> 
       ...
       {(!loading && !categories)&&<div style={{textAlign:"center",marginTop:300,marginBottom:300}}>
        <h1>Something went wrong try again !</h1>
        <Button style={{backgroundColor:"red"}} onClick={()=>dispatch(fetchAllCategories())}>Try Again</Button></div>}
