  ...
  var m = "day",
    ...
    c = {
      ...
      _perSecondHandler: function () {
        ...
        0 <= r
          ? (c._refreshUnitsDom.apply(this, [r]), c._applyEffectSwitch.apply(this, [t.effectType]))
      ...
      _refreshUnitsDom: function (e) {
        ...
        for (var a = 0; a < o.length; a++) {
          ...
          u.data("syotimer-unit-value", d),
            l(".syotimer-cell__value", u).html(y.format2(d, s !== m && i.doubleNumbers)),
            l(".syotimer-cell__unit", u).html(l.syotimerLang.getNumeral(d, i.lang, s));
        }
      },
        ...
        "none" === e
          ...
          : "opacity" !== e ||
            ((i = a.data("syotimer-items")[t]) &&
              ...
              l(".syotimer-cell__value", i).animate({ opacity: 0.1 }, 1e3, "linear", function () {
                c._perSecondHandler.apply(r, []);
              }),
        ...
        var i,
          ...
          s = t.periodic
            ? ((r = e / (1e3 * (o = y.getPeriodUnit(t.periodUnit)))),
              ...
              (r = Math.abs(r)),
              0 <= a
                ? ((n = 0 === (n = r % t.periodInterval) ? t.periodInterval : n), --n)
