        ...
        e.define("select2/results", ["jquery", "./utils"], function (p, h) {
          ...
          return (
              ...
              this.data.current(function (e) {
                ...
                t.$results.find(".select2-results__option[aria-selected]").each(function () {
                  var e = p(this),
                    ...
                    n = "" + t.id;
                  (null != t.element && t.element.selected) || (null == t.element && -1 < p.inArray(n, r))
            ...
            (r.prototype.option = function (e) {
              ...
              for (var r in (e.disabled && (delete n["aria-selected"], (n["aria-disabled"] = "true")),
        ...
        e.define("select2/data/tokenizer", ["jquery"], function (d) {
          ...
          return (
            ...
            (e.prototype.query = function (e, t, n) {
              ...
              i.term !== t.term && (this.$search.length && (this.$search.val(i.term), this.$search.focus()), (t.term = i.term)),
                e.call(this, t, n);
            }),
            ...
            (e.prototype.query = function (n, r, i) {
              ...
              this.current(function (e) {
                ...
                0 < o.maximumSelectionLength && t >= o.maximumSelectionLength
                  ? o.trigger("results:message", { message: "maximumSelected", args: { maximum: o.maximumSelectionLength } })
                  : n.call(o, r, i);
              });
            }),
            e
                    ...
                    try {
                      ...
                      try {
                        ...
                        t.debug &&
                          ...
                          console.warn &&
                          console.warn(
                            'Select2: The language file for "' + u + '" could not be automatically loaded. A fallback will be used instead.'
                          );
                        continue;
                      }
                    }
              ...
              null == this.options.multiple && (this.options.multiple = e.prop("multiple")),
                ...
                null == this.options.language &&
                  (e.prop("lang")
                    ...
                    : e.closest("[lang]").prop("lang") && (this.options.language = e.closest("[lang]").prop("lang"))),
